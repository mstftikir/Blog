...
import com.mstftikir.github.blog.entities.Role;
import com.mstftikir.github.blog.entities.UserInfo;
import com.mstftikir.github.blog.pojos.UserRegistration;
...
public class UserController {
    ...
    public String register(@RequestBody UserRegistration userRegistration){
        ...
        userService.save(new UserInfo(userRegistration.getUsername(), userRegistration.getPassword(), Arrays.asList(new Role("USER"), new Role("ACTUATOR"))));
        return "User created";
    }
